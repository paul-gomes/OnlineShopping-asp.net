...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridViewProduct" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ProductID" DataSourceID="LinqDataSourceProduct" ForeColor="#333333" GridLines="None" OnRowCommand="GridViewProduct_RowCommand" ShowHeader="False">
